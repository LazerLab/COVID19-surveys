...
read_preprocess_pop_data <- function(census_pop_path = here("Data", "18_pop.csv"),
...
read_preprocess_CDC_vax_data <- function(cdc_vax_data_path = here("Data",
                                                                  "CDC",
                                                                  "COVID-19_Vaccination_Age_and_Sex_Trends_in_the_United_States__National_and_Jurisdictional.csv"
                                                                  )){
...
read_preprocess_IPSOS_data <- function(ipsos_path = here("Data", "Ipsos/"),
                                       ipsos_waves_dates = here("Data", "Ipsos_dates.csv"),
                                       date_return = "mid") {
...
read_infections_national_admin_data <- function(nyt_path = "https://raw.githubusercontent.com/nytimes/covid-19-data/master/us.csv",
                                       write_path = here("Data", "nyt_us_data.csv"),
                                       census_path = here("Data", "total_pop.csv")) {
...
read_infections_state_admin_data <- function(nyt_path = "https://raw.githubusercontent.com/nytimes/covid-19-data/master/us-states.csv",
                                                write_path = here("Data", "nyt_states_data.csv"),
                                                census_path = here("Data", "total_pop.csv")) {
